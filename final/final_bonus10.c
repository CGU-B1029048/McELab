...
int old_x, old_y, old_ghost_x, old_ghost_y;
int old_ghost2_x, old_ghost2_y;
int ghost_x, ghost_y;
...
void move_pacman(int pac_status, int ghost_status, int ghost2_status) {
	old_x = x_cur;
	old_y = y_cur;
	old_ghost_x = ghost_x;
	old_ghost_y = ghost_y;
	old_ghost2_x = ghost2_x;
	old_ghost2_y = ghost2_y;
	...
	if (ghost2_status == 1 && ghost2_y < 15) ghost2_y++;//right
	else if (ghost2_status == 2 && ghost2_y > 0) ghost2_y--;//left
	else if (ghost2_status == 3 && ghost2_x > 0) ghost2_x--;//up
	else if (ghost2_status == 4 && ghost2_x < 7) ghost2_x++;//down
